...
- 普通局部 UI 状态
- 和表单动作无关的状态
- 只是想用一个新 Hook 替代简单的 [[./React-useState|useState]]
...
- [[./React-useState|useState]]
 负责一般局部状态
- [[./React-useOptimistic|useOptimistic]]
 负责先给用户乐观反馈
...
- 在 [[../Knowledges/React Hooks|React Hooks]] 里，它属于并发时代和表单动作语义增强的一部分
- 和 [[./React-useOptimistic|useOptimistic]] 一起看，可以区分“先反馈”与“结果落地”的不同层次
- 和 [[./React-useState|useState]] 对比，可以更清楚什么时候该从普通局部状态升级到 action 驱动状态
