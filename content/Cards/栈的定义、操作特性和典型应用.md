...
updated: 2026-05-16 20:18:04
share: true
noteId: 1778930946292
---
栈的定义、操作特性和典型应用是什么？
...
# 操作特性
“操作受限”的线性表，只允许在一端插入和删除数据。相比于[[./数组的定义、操作特性和典型应用|数组的定义、操作特性和典型应用]]和[[./链表的定义、操作特性和典型应用|链表的定义、操作特性和典型应用]]，更少的操作结构，意味着更加可控，不易出错的状态。
# 顺序栈：由数组实现的栈
```ts
class ArrayStack {
