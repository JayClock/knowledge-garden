...
share: true
noteId: 1778930948244
---
JS async/await 的执行机制是什么？

---

# JS async await 的执行机制的定义

- 异步回调会带来 callback hell
- [[./JS Promise 的核心机制是什么？|Promise]] 通过 then、catch 链式调用，一定程度上会解决了回调函数的问题
...
async 函数返回结果都是 [[./JS Promise 的核心机制是什么？|Promise]] 对象（如果函数没返回 Promise，则自动封装一下）
