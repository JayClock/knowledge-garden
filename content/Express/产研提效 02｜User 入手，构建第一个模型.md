...
```
从上面的接口信息，以及产品帮助文档，我们可以梳理出以下用户故事：
1. 作为一个用户，我希望可以加入别人的工作区，以此和别人协同
2. 作为一个用户，我希望可以创建工作区，以此独立工作空间

概念词典

| 中文命名 | 英文命名      | 描述                                                                                                                                                      |
| ---- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 工作区  | Workspace | 轻流工作区是轻流无代码平台的核心，也是企业系统搭建者、管理员与系统使用者协作的空间。<br><br>在轻流，这些不同的系统角色通过同一套账号体系与统一的路径进入同一个工作区，轻流能够基于不同的系统角色，设定相应的工作区权限，针对一般用户隐藏系统搭建与管理后台入口，在一个界面中汇集搭建、管理与使用操作。 |
| 用户   | User      | 轻流的用户                                                                                                                                                   |
