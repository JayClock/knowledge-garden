...
我们大部分人对于 ai，都是以提升自身效率为前提去使用的，却忽视了软件开发真正的成本在于**协作效应**。好的协作效应只能是 1 + 1 > 2 的效果，但我们平时的协作效应都是 1 + 1 < 2，甚至是 1 + 1 < 1。正如前几年全栈工程师所带来的美好愿景，企业希望找一个前后端技术都懂的人（现在是初级开发 + ai），来减少用人的成本。但是实际上，这样只能把整个团队割裂
