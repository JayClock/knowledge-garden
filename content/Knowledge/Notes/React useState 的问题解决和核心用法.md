...
这是 [[React Hooks]] 体系里最基础的一层能力，也是 [[React 状态管理]] 的起点。
...
- 直接在 render 中计算
- 或者交给 [[React useMemo 的问题解决和核心用法|useMemo]] 做缓存
...
这时通常该进入 [[React useReducer 的问题解决和核心用法|useReducer]]。

如果共享范围继续扩大，再进入 [[React-useContext]] 或更上层的 [[React 状态管理]]。
...
- 在 [[React Hooks]] 里，它是函数组件有状态的起点
- 在 [[React 状态管理]] 里，它是最小、最局部的状态管理方案
- 在 [[React useReducer 的问题解决和核心用法|useReducer]] 里，可以看到它升级后的形态
