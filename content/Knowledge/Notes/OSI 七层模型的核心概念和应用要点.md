...
4. 传输层：为上层服务提供端到端的通信服务，负责错误恢复、浏览控制和确保完整的数据传输。像 [[TCP 的工作机制和关键特性|TCP(传输控制协议)]] 和 [[UDP 的工作机制和关键特性|UDP(用户数据报协议)]]这样的协议在这一层运行。
...
7. 应用层：OSI 模型的最高层，直接为终端用户应用程序提供网络服务，负责电子邮件、文件传输和网页浏览等网络服务。像 [[HTTP 各版本的关键区别|HTTP]]、FTP 和 SMTP 这样的协议在这一层运行。
...
![Pasted image 20250504220355](https://knowledge-garden.oss-cn-shanghai.aliyuncs.com/images/OSI%20%E4%B8%8E%20TCP-IP%20%E5%8F%82%E8%80%83%E6%A8%A1%E5%9E%8B%E5%AF%B9%E6%AF%94.png)
