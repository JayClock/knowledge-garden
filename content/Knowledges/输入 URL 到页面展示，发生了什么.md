...
- 用户输入关键字并键入回车
- （可能有）当前页面触发 beforeunload 事件，比如**表单未提交完成**
...
- [[../Cards/浏览器缓存|缓存]]判断：**网络进程**会判断所请求的资源是否在缓存里，如果请求的资源在缓存里并且没有失效，那么就直接使用，借此提高 [[../Cards/TTFB|TTFB]] 指标，否则向服务器发起新的请求。
- 网络进程发起真正的 URL 请求
