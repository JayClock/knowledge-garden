...
# 操作特性
和[[../Cards/栈的定义、操作特性和典型应用|栈的定义、操作特性和典型应用]]一样，也是“操作受限”的线性表，只允许在一端插入和删除数据。相比于[[../Cards/数组的定义、操作特性和典型应用|数组的定义、操作特性和典型应用]]和[[../Cards/链表的定义、操作特性和典型应用|链表的定义、操作特性和典型应用]]，更少的操作结构，意味着更加可控，不易出错的状态。
# 顺序队列：用数组实现的队列
...
- [[../Cards/队列的核心特性|队列的核心特性]]
- [[../Cards/顺序队列可能产生数据搬移的原因|顺序队列可能产生数据搬移的原因]]
- [[../Cards/链式队列的优势和风险|链式队列的优势和风险]]
- [[../Cards/循环队列避免顺序队列的数据搬移的方法|循环队列避免顺序队列的数据搬移的方法]]
- [[../Cards/阻塞队列的问题解决|阻塞队列的问题解决]]
