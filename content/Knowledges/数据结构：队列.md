...
updated: 2026-05-16 19:27:14
share: true
noteId: 1778807088802
---
队列的定义、操作特性和典型应用是什么？
...
# 操作特性
和[[../Cards/栈的定义、操作特性和典型应用是什么？|栈的定义、操作特性和典型应用是什么？]]一样，也是“操作受限”的线性表，只允许在一端插入和删除数据。相比于[[../Cards/数组的定义、操作特性和典型应用是什么？|数组的定义、操作特性和典型应用是什么？]]和[[../Cards/链表的定义、操作特性和典型应用是什么？|链表的定义、操作特性和典型应用是什么？]]，更少的操作结构，意味着更加可控，不易出错的状态。
# 顺序队列：用数组实现的队列
...
- [[../Cards/队列的核心特性是什么？|队列的核心特性是什么？]]
- [[../Cards/顺序队列为什么可能产生数据搬移？|顺序队列为什么可能产生数据搬移？]]
- [[../Cards/链式队列的优势和风险是什么？|链式队列的优势和风险是什么？]]
- [[../Cards/循环队列如何避免顺序队列的数据搬移？|循环队列如何避免顺序队列的数据搬移？]]
- [[../Cards/阻塞队列用来解决什么问题？|阻塞队列用来解决什么问题？]]
