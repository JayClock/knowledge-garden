...
updated: 2026-05-16 19:27:22
share: true
noteId: 1778807088488
---
设计系统的渐进式组件的核心问题和演进思路是什么？
...
- [[../Cards/渐进式组件设计为什么要从原生 HTML 开始？|渐进式组件设计为什么要从原生 HTML 开始？]]
- [[../Cards/设计系统组件为什么应按能力检测选择增强层？|设计系统组件为什么应按能力检测选择增强层？]]
- [[../Cards/为什么组件的样式层不应该破坏基础语义？|为什么组件的样式层不应该破坏基础语义？]]
- [[../Cards/为什么智能组件能力应作为可降级的增强层？|为什么智能组件能力应作为可降级的增强层？]]
