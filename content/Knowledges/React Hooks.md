...
updated: 2025-10-09 17:26:41
share: true
in:
  - "[[Maps|Maps]]"
---
- 为什么需要 Hooks ?
	1.  React 组件之间不会互相继承，我 们不推荐创建一个 Button 组件，然后再创建一个 Dropdown Button 来继承 Button
...
- 引用 Hooks
	...
	2. [[../Cards/react-forwardRef|forwardRef]]：用于访问内部组件实例
- 性能优化 Hooks
...
- 其它 Hooks
	...
	8. [[React-useSyncExternalStore|useSyncExternalStore]]: 用于订阅外部存储（如 Redux 或 Zustand）的状态。
	9. useInsertionEffect: 为 CSS-in-JS 库的作者特意打造的，在布局副作用触发之前将元素插入到 DOM 中
- 自定义 Hooks
	1. [[../Cards/React useTimer|useCount]]
	2. [[react useRequest|useRequest]]
- hooks 定义规则：
