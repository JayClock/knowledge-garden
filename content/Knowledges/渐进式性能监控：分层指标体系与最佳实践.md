...
- [[../Cards/渐进式性能监控按用户体验阶段分层采集指标|渐进式性能监控按用户体验阶段分层采集指标]]
- [[../Cards/核心内容加载阶段关注用户何时看到主要内容|核心内容加载阶段关注用户何时看到主要内容]]
- [[../Cards/视觉稳定阶段用布局偏移判断加载体验|视觉稳定阶段用布局偏移判断加载体验]]
- [[../Cards/交互准备阶段衡量页面何时可以响应用户|交互准备阶段衡量页面何时可以响应用户]]
- [[../Cards/增强功能加载阶段监控非核心能力是否按需到达|增强功能加载阶段监控非核心能力是否按需到达]]
- [[../Cards/运行时性能阶段关注长期会话中的卡顿和资源压力|运行时性能阶段关注长期会话中的卡顿和资源压力]]
